...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
  <head>
    ...
    <body class="antialiased">
      ...
      <nav class="navbar navbar-dark " style="background-color: rgb(209, 158, 238)" >
        <div class="container">
      ...
      <div class="container mt-2">
        <h1 class="text-dark" style="text-align: center">Dashboard</h1>
      </div>
      
      <div class="container">
        <table class="table table-bordered mt-4">
          <thead class="table" style="background-color: rgb(209, 158, 238)">
              <tr>
                  <th>Id Pelaporan</th>
                  <th>NIK</th>
                  <th>Id Kategori</th>
              ...
              <tr>
                ...
                <td>
                    <div class="d-flex flex-row col-sm-12">
                        ...
                        <div class="p-2">
                            <form action="<?php echo e(route('aspirasi.delete', $aspirasi->id_pelaporan)); ?>" method="POST">
  ...
  </html><?php /**PATH C:\xampp\htdocs\aspirasi\resources\views/dashboard.blade.php ENDPATH**/ ?>