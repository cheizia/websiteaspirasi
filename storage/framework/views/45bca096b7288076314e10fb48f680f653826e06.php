<?php $__env->startSection('container'); ?>
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                <a href="/aspirasi" class="btn btn-success" style="background-color: darkcyan">Lihat Aspirasi</a>
            </div>
            ...
            <div class="mt-8 bg-success text-white fs-5 dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg p-6">
                <form action="<?php echo e(route('aspirasi')); ?>" method="POST">
                       <h1 style="color: gainsboro">Aspirasi Masyarakat</h1>
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Pemas-Reyzar\resources\views/welcome.blade.php ENDPATH**/ ?>