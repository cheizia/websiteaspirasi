    ...
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                <h1 class="text-info display-1">Aspirasi Masyarakat</h1>
            </div>
            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                <a href="/aspirasi" class="btn btn-success">Lihat Aspirasi</a>
            </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\UprakAspirasi\resources\views/welcome.blade.php ENDPATH**/ ?>